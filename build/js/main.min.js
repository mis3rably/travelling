...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var burgerButton = header.querySelector('.header__burger-button');
  var heroSlide = document.querySelectorAll('.hero__slide');
  if (header && heroSlide) {
    var headerHeight = 180;
    var currentHeroPadding = window.getComputedStyle(heroSlide[0]).getPropertyValue('padding-top');
    var breakpoint = window.matchMedia('(min-width:1200px)');
    var adjustSlidesPadding = function adjustSlidesPadding() {
      if (breakpoint.matches) {
        currentHeroPadding = window.getComputedStyle(heroSlide[0]).getPropertyValue('padding-top');
        heroSlide.forEach(function (el) {
          el.style.paddingTop = "".concat(header.offsetHeight - headerHeight + parseInt(currentHeroPadding, 10), "px");
        });
  ...
  if (burgerButton && header) {
    ...
    burgerButton.addEventListener('click', function () {
      if (!header.classList.contains('header--opened')) {
        ...
        var burgerList = document.querySelector('.header__navigation-list');
        if (burgerList) {
          burgerList.addEventListener('click', function (evt) {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var heroVideoWrapper = document.querySelector('.hero__video-wrapper');
    var heroVideo = document.querySelector('.hero__video');
    var heroPreview = document.querySelector('.hero__video-wrapper img');
    var heroVideoButton = document.querySelector('.hero__video-button');
    var audioButton = document.querySelector('.hero__audio-button');
    var heroAudio = document.querySelector('.hero__audio');
    var audioWrapper = document.querySelector('.hero__audio-player');
    var questionsFormButton = document.querySelector('.questions__form button[type="submit"]');
    ...
    if (questionsFormButton) {
      questionsFormButton.addEventListener('click', function (evt) {
        evt.preventDefault();
...
},{"./modules/form-validate/form":3,"./modules/scroll-lock/scroll-lock":10}],2:[function(require,module,exports){
"use strict";
